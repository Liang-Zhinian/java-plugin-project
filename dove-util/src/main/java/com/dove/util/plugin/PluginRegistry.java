...
public abstract class PluginRegistry {
	...
	public void init(String pluginsDir) {
		...
		// "com.dove.util.ShadingPathResolver");
		// properties.put("com.dove.util.ShadingPathResolver.shadowFolder",
		// pluginsDir + "/../.plugins");
		properties.put("com.dove.util.ShadingPathResolver.unpackMode", "smart");
