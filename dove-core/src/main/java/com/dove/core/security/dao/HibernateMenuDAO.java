...
import com.dove.core.security.Menu;
import com.dove.core.security.MenuGroup;
import com.dove.core.security.Permission;
...
public class HibernateMenuDAO extends HibernatePersistentObjectDAO<Menu> implements MenuDAO {
	...
	/**
	 * @see com.dove.core.security.dao.MenuDAO#findByParentId(long)
	 */
	...
	/**
	 * @see com.dove.core.security.dao.MenuDAO#isMenuWriteable(long, long)
	 */
